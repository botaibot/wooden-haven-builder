      ...
      <div className="absolute inset-0 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div 
            ...
            style={{
              background: 'linear-gradient(90deg, rgba(246, 242, 236, 0.85) 0%, rgba(246, 242, 236, 0.7) 60%, rgba(246, 242, 236, 0.5) 100%)'
            }}
          />
        </div>
        ...
        >
          <div 
            className="absolute inset-0"
            style={{
              background: 'linear-gradient(270deg, rgba(246, 242, 236, 0.85) 0%, rgba(246, 242, 236, 0.7) 60%, rgba(246, 242, 236, 0.5) 100%)'
            }}
          />
        </div>
      </div>
