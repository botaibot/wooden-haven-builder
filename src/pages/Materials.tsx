...
const Materials = () => {
  const materials = [
    ...
    },
    {
      ...
      unit: "ud.",
      sizes: [
        { label: "6000 мм x 100 мм x 100 мм", value: "100x100", price: 70 },
        { label: "6000 мм x 120 мм x 60 мм", value: "120x60", price: 53 },
        { label: "6000 мм x 160 мм x 60 мм", value: "160x60", price: 70 },
        { label: "6000 мм x 200 мм x 60 мм", value: "200x60", price: 84 },
        { label: "6000 мм x 160 мм x 80 мм", value: "160x80", price: 85 },
