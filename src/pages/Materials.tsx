...
const Materials = () => {
  const materials = [
    ...
    },
    {
      ...
      description: "Имитация бревна с соединением шип-паз (блок-хаус) - материал для отделки в виде полубревна. Используется для отделки с��ен внутри помещений и для придания внешнего вида деревянному дому снаружи. Может монтироваться на обрешетку или непосредственно на доски.",
